...
console.log(bankUser2.getBalance()); // Output: Current balance: 5000
console.log(bankUser2.deposit(1000)); // Output: Deposited 1000 into account. New balance: 6000
console.log(bankUser2.withdraw(2000)); // Output: Withdrawn 2000 from account. New balance: 4000
console.log(bankUser2.getBalance()); // Output: Current balance: 4000
console.log(bankUser2.getTransactions()); // Output: ['Deposit: +1000', 'Withdrawal: -2000']